...
class AddGym : AppCompatActivity(),OnMapReadyCallback {

    private lateinit var textview2gym: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textview2gym=findViewById(R.id.textview2gym)
        retrieveGymAddressFromFirestore()
    }

    fun editGym(view: View) {
        val intent= Intent(this,EditGym::class.java)
